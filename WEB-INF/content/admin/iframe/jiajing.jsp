...
$(document).ready(function(){
	$("div.pagin").pageNum({
		totalPage : ${perfectSubjectBean.totalPage},
		currentPage : ${perfectSubjectBean.currentPage},
...
<article id="jiajing">
	...
	<s:if test="perfectSubjectBean.list.size() == 0">
		<p class="noData">目前还没有被加精的主题</p>
	</s:if>
	<s:else>
		...
		<table>
			...
			<s:iterator value="perfectSubjectBean.list" var="subject">
			<tr>
				...
				<td><a class="removePerfect" data="${sub_id}" href="javascript:void(0);">去除加精</a></td>
			</tr>
			</s:iterator>
		</table>
